  ...
  return (
    <AuthLayout>
      <div className="lg:w-[100%] h-auto md:h-full flex flex-col justify-center mt-10 md:mt-0">
        {/* High-contrast headings/subtext via theme tokens */}
        <h3 className="text-xl font-semibold" style={{ color: "var(--text-strong)" }}>
          Create an Account
        </h3>
        <p className="text-xs mt-[5px] mb-6" style={{ color: "var(--text-muted)" }}>
        ...
        <form onSubmit={handleSignUp}>
          ...
          <p className="text-[13px] mt-3 text-center" style={{ color: "var(--text)" }}>
